...
public class DonationRecyclerAdapter3 extends RecyclerView.Adapter<DonationRecyclerAdapter3.ViewHolder> {

    private Intent intent;
    private Context context;
    private ArrayList<DonationItem3> mDonationList = new ArrayList<>();

    @NonNull
    // @NotNull
    @Override
    public DonationRecyclerAdapter3.ViewHolder onCreateViewHolder(@NonNull /*@NotNull*/ ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull /*@NotNull*/ DonationRecyclerAdapter3.ViewHolder holder, int position) {
        DonationItem3 donationItem3 = mDonationList.get(position);
        holder.onBind(donationItem3);
    ...
    public void setDonationList(Context context, ArrayList<DonationItem3> list){
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(DonationItem3 item){
