...
public class DonationRecyclerAdapter extends RecyclerView.Adapter<DonationRecyclerAdapter.ViewHolder> {
    ...
    private ArrayList<DonationItem> mDonationList = new ArrayList<DonationItem>();

    @NonNull
    // @NotNull
    @Override
    public DonationRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull /*@NotNull*/ ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull /*@NotNull*/ DonationRecyclerAdapter.ViewHolder holder, int position) {
        DonationItem donationItem = mDonationList.get(position);
        holder.onBind(donationItem);
    ...
    public void setDonationList(Context context, ArrayList<DonationItem> list){
